...
** Projects
*** Project management
**** TODO Persist (this has disappeared?)
...
#+begin_src elisp
  ...
  :custom
  (org-cite-global-bibliography `(,stag-bibliography-file))
  (org-cite-insert-processor 'citar)
  (org-cite-follow-processor 'citar)
  (org-cite-activate-processor 'citar)
  (org-cite-export-processors stag-cite-export-processors)
  (citar-notes-path (list org-roam-directory))
