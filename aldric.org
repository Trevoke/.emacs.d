...
(load-library "ox")
(load-library "org-tempo") ;; quick templates
  ...
  (or org-directory
      (customize-save-variable 'org-directory
                               (file-name-as-directory (read-directory-name
                                                        ...
                                                        "~/"))))
  (setq stag-gtd-projects (concat org-directory "Projects.org")
        stag-gtd-tickler  (concat org-directory "Tickler.org"))
  (setq org-agenda-files `(,stag-gtd-projects ,stag-gtd-tickler))
#+END_SRC
** Diary
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (org-defkey org-mode-map "\C-cs" 'stag-gtd-refile)
  (org-defkey org-mode-map "\C-co" 'stag-gtd-create-single-task-project)
  ...
  (defun stag-gtd-refile ()
    (interactive)
    (org-set-tags-command)
    (org-refile))

  (defun stag-gtd-create-single-task-project ()
    (interactive)
...
#+END_SRC
* Programming
** Path modification for executables
#+BEGIN_SRC elisp
...
;;  (use-package ox-ioslide)
  (use-package ox-reveal
    ...
    :config
    (use-package htmlize)
    (setq org-reveal-root "file:///Users/aldricgiacomoni/src/vendor/reveal.js-3.8.0"))
#+END_SRC
* Email
** TODO Add BBDB
** Sending email
