...
** Adding images
#+BEGIN_SRC emacs-lisp
  (use-package org-download :pin "melpa")
#+END_SRC
** keybindings
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package org-gtd
    :after org
    :demand t
    :load-path "~/src/projects/org-gtd.el"
    :custom
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org-agenda
    ...
    (org-agenda-custom-commands '(("g" "Scheduled today and all NEXT items" ((agenda "" ((org-agenda-span 1))) (todo "NEXT|WAIT"))))))
#+END_SRC
** Diary
#+BEGIN_SRC emacs-lisp
